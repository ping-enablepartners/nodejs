...
class PKCEManager {
    ...
    async prepareAuthParams (oauthParams) {
        ...
        // Set default code challenge method, if none provided( code_challenge_method is an optional parameter).
        // It defaults to plain if not specified (which generates an error when the S256_REQUIRED PKCE enforcement option is specified by the application).
    ...
    /**
     * Get default code challenge method that is a SHA-256.
